 ...
 */
public class InputDataListFactoryTest {

    private Tokenizer tokenizer = new TokenizerImpl();

    private MultiListFactory multiListFactory = new MultiListFactoryImpl();

    private InputDataListFactory inputDataListFactory = new InputDataListFactoryImpl(tokenizer, multiListFactory);

    @Test
    public void testCreate() {
        List<String> inputDataStringList = new ArrayList<>();
        String inputDataAsString = "boys drink beer in pub#N V N PR N";
        inputDataStringList.add(inputDataAsString);
    ...
    public void testCreateWithSubSentences() {
        ...
        inputDataStringList.add(inputDataString);
        List<InputData> inputDataList = inputDataListFactory.create(inputDataStringList);
